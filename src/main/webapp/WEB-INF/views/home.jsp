...
<body>
    ...
    <main> 
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            ...
                            <div class="gallery-img size-img" style="background-image: url(/resources/assets/img/gallery/gallery1.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url(/resources/assets/img/gallery/gallery2.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url(/resources/assets/img/gallery/gallery3.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-4  col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url(/resources/assets/img/gallery/gallery4.png);"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="form-wrapper">
                            ...
                            <form id="contact-form" action="#" method="POST">
                                ...
                                <!-- shape-dog -->
                                <div class="shape-dog">
                                    <img src="/resources/assets/img/gallery/shape1.png" alt="">
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <!-- Team End -->
        <!--? Testimonial Start -->
        <div class="testimonial-area testimonial-padding section-bg" data-background="/resources/assets/img/gallery/section_bg03.png">
            <div class="container">
                                ...
                                <div class="testimonial-caption ">
                                    ...
                                    <div class="testimonial-founder">
                                        <div class="founder-img mb-40">
                                            <img src="/resources/assets/img/gallery/testi-logo.png" alt="">
        ...
        <div class="contact-animal-owner section-bg" data-background="/resources/assets/img/gallery/section_bg04.png">
            <div class="container">
